...
#if !defined(__CCHESS_PROFILING)
#define __CCHESS_PROFILING
...
CCHESS_STATIC_FUNCTION CCHESS_FORCE_INLINE uint64_t get_timestamp(void)
{
    LARGE_INTEGER ticks; 
...
CCHESS_STATIC_FUNCTION CCHESS_FORCE_INLINE double get_elapsed_time(const uint64_t start, const double unit_multiplier) 
{
...
#if defined(CCHESS_ENABLE_PROFILING)
...
#endif /* defined(CCHESS_ENABLE_PROFILING) */

#endif /* __CCHESS_PROFILING */